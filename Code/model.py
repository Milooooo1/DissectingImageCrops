...
def Fpatch():
    ...
    x = Conv2D(64, (3, 3),  padding='same', name="ResNet18_conv1")(x)
    x = Conv2D(64, (3, 3),  padding='same', name="ResNet18_conv2")(x)
    x = Conv2D(64, (3, 3),  padding='same', name="ResNet18_conv3")(x)
    x = Conv2D(64, (3, 3),  padding='same', name="ResNet18_conv4")(x)    
    
    x = Conv2D(128, (3, 3), padding='same', name="ResNet18_conv5")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet18_conv6")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet18_conv7")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet18_conv8")(x)

    x = Conv2D(256, (3, 3), padding='same', name="ResNet18_conv9")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet18_conv10")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet18_conv11")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet18_conv12")(x)

    x = Conv2D(512, (3, 3), padding='same', name="ResNet18_conv13")(x)
    x = Conv2D(512, (3, 3), padding='same', name="ResNet18_conv14")(x)
    x = Conv2D(512, (3, 3), padding='same', name="ResNet18_conv15")(x)
    x = Conv2D(512, (3, 3), padding='same', name="ResNet18_conv16")(x)
...
def Fglobal():
    ...
    x = Conv2D(64, (7, 7), strides=2, padding='same', name="ResNet34_conv0")(input_layer)
    x = MaxPooling2D((3,3), 2, name="ResNet34_MaxPool")(x) 
    
    x = Conv2D(64, (3, 3), padding='same', name="ResNet34_conv1")(x)
    x = Conv2D(64, (3, 3), padding='same', name="ResNet34_conv2")(x)
    x = Conv2D(64, (3, 3), padding='same', name="ResNet34_conv3")(x)
    x = Conv2D(64, (3, 3), padding='same', name="ResNet34_conv4")(x)
    x = Conv2D(64, (3, 3), padding='same', name="ResNet34_conv5")(x)
    x = Conv2D(64, (3, 3), padding='same', name="ResNet34_conv6")(x)
    
    x = Conv2D(128, (3, 3), padding='same', name="ResNet34_conv8")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet34_conv9")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet34_conv10")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet34_conv11")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet34_conv12")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet34_conv13")(x)
    x = Conv2D(128, (3, 3), padding='same', name="ResNet34_conv14")(x)
    
    x = Conv2D(256, (3, 3), strides=2,  padding='same', name="ResNet34_conv16")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv17")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv18")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv19")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv20")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv21")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv22")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv23")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv24")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv25")(x)
    x = Conv2D(256, (3, 3), padding='same', name="ResNet34_conv26")(x)

    x = Conv2D(512, (3, 3), strides=2,  padding='same', name="ResNet34_conv27")(x)
    x = Conv2D(512, (3, 3), padding='same', name="ResNet34_conv28")(x)
    x = Conv2D(512, (3, 3), padding='same', name="ResNet34_conv29")(x)
    x = Conv2D(512, (3, 3), padding='same', name="ResNet34_conv30")(x)
    x = Conv2D(512, (3, 3), padding='same', name="ResNet34_conv31")(x)
    x = Conv2D(512, (3, 3), padding='same', name="ResNet34_conv32")(x)
